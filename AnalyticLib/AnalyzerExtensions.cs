...
namespace AnalyticLib
{
    public static class AnalyzerExtensions
    {
        private static HashSet<string> _stopWords = new HashSet<string>()
        {
            ...
            "etc", "even", "ever", "every", "everyone", "everything", "everywhere", "except", "few", "fifteen", "fify", "fill", "find", "fire",
            ...
            "would", "yet", "you", "your", "yours", "yourself", "yourselves", "the", "s", "ve", "like", "make", "makes", "making",
            "000", "widget","come", "x", "new", "used", "t", "today",  "list", "1", "week", "month", "news", "monthes", "enable","needs","early",
            "non", "just",  "came", "using", "based", "year", "tool","g", "great", "far",
            "use","added","let","look", "use","|", "l", "pt", "mod", "b", "c", "d"
        };
        public static bool IsStopWord(this string word)
        {
            int number;
            if (_stopWords.Contains(word) || int.TryParse(word,out number)) return true; else return false;
        }
    }
}
